...
const mockTestButtons = [
    ...
    document.getElementById('mocktest11'),
    document.getElementById('mocktest12'),
    document.getElementById('mocktest13'),
    document.getElementById('mocktest14'),
    document.getElementById('mocktest15'),
    document.getElementById('mocktest16'),
    document.getElementById('mocktest17'),
    document.getElementById('mocktest18'),
    document.getElementById('mocktest19'),
    document.getElementById('mocktest20')
];
...
// Function to select exactly 65 questions totaling exactly 100 marks
...
async function initTest() {
    ...
    timerInterval = startTimer(10800, timerElement);
    displayCurrentQuestion();
}
