...
let correctAnswersCount = 0;  //for result purpose
let timerInterval;
let userAnswers = {};
...
function displayCurrentQuestion() {
    ...
    // Identify the Question Type -MSQ/MCQ/NAT
    let questionType = '';
    let typeClass = '';
...
function toggleButtons() {
    ...
    if (prevBtn && nextBtn) {
        ...
        nextsaveBtn.disabled = currentQuestionIndex === selectedQuestions.length - 1;
    }
}
